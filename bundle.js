...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactSwap = __webpack_require__(164);
	...
	var Clickable = _react2.default.createClass({
	...
	var Hoverable = _react2.default.createClass({
	...
	var Delayed = _react2.default.createClass({
	  displayName: 'Delayed',
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h3',
	            { style: { marginLeft: 20 }, 'data-swap-handler': 1 },
	            'Click me'
	          )
	        ),
	        _react2.default.createElement(
	...
	var DeepTableSwap = _react2.default.createClass({
	  displayName: 'DeepTableSwap',
	  render: function render() {
	    return _react2.default.createElement(
	      'table',
	      { style: { backgroundColor: 'rgba(0, 0, 0, 0.05)' } },
	...
	var WithCallback = _react2.default.createClass({
	  displayName: 'WithCallback',
	  getInitialState: function getInitialState() {
	    return { opened: false };
	  },
	  onSwap: function onSwap(opened) {
	    this.replaceState({ opened: opened });
	  },
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	...
	var ToggleFromOutside = _react2.default.createClass({
	  displayName: 'ToggleFromOutside',
	  getInitialState: function getInitialState() {
	    return { opened: false };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactSwap = _react2.default.createClass({
	  ...
	  propTypes: {
	    ...
	    isHover: _react2.default.PropTypes.bool,
	    isSwapped: _react2.default.PropTypes.bool,
	    delay: _react2.default.PropTypes.number,
	    dataHandler: _react2.default.PropTypes.string,
	    onSwap: _react2.default.PropTypes.func
	  },
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(_ref) {
	    ...
	    if (typeof isSwapped !== 'undefined' && this.state.isSwapped !== isSwapped) {
	      this.replaceState({ isSwapped: isSwapped });
	    }
	  },
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"repository": {
			"type": "git",
			"url": "https://github.com/nkbt/react-swap.git"
		},
		"keywords": [
			"component",
			"react-component",
		...
		"license": "MIT",
		"bugs": {
			"url": "https://github.com/nkbt/react-swap/issues"
		},
		"homepage": "https://github.com/nkbt/react-swap",
		"peerDependencies": {
			"react": "^0.14 || ^15"
		},
		"devDependencies": {
